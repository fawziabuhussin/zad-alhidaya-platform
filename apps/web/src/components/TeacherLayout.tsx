...
export default function TeacherLayout({ children }: TeacherLayoutProps) {
  ...
  const navItems = [
    { href: '/teacher', label: 'لوحة التحكم', icon: '📊', category: 'main' },
    { href: '/teacher/courses', label: 'دوراتي', icon: '📚', category: 'content' },
    { href: '/teacher/exams', label: 'الامتحانات', icon: '📝', category: 'assessments' },
    { href: '/teacher/homework', label: 'الواجبات', icon: '📋', category: 'assessments' },
    { href: '/teacher/grades', label: 'التقييمات', icon: '⭐', category: 'assessments' },
  ];
